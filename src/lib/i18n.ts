...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'conv.deleteConfirm': '确定删除此会话吗？',
    'conv.deleteConfirmDetail': '此操作不可撤销。',
    'conv.deleteAll': '删除全部会话',
    'conv.deleteAllConfirm': '确定删除「{project}」下的全部 {count} 个会话吗？',
    ...
    'provider.formatHint': '大多数第三方接口使用 OpenAI 格式。Anthropic 官方直连使用 Anthropic 格式。',
    'provider.modelMappings': '模型映射',
    'provider.modelMappingsHint': '填写接口的模型名，至少填一个用于测试连接',
  ...
  en: {
    ...
    'conv.deleteConfirm': 'Delete this session?',
    'conv.deleteConfirmDetail': 'This action cannot be undone.',
    'conv.deleteAll': 'Delete All Sessions',
    'conv.deleteAllConfirm': 'Delete all {count} sessions in "{project}"?',
