...
export function AvatarCropModal({ imageFile, onSave, onCancel }: AvatarCropModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/50"
      onClick={onCancel}>
      <div className="bg-bg-card rounded-xl shadow-2xl p-6 flex flex-col items-center gap-4 w-[320px]"
        ...
        <div
          ref={containerRef}
          className="relative rounded-lg overflow-hidden cursor-grab active:cursor-grabbing select-none bg-black/10 dark:bg-white/10"
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="w-8 h-8 rounded-md border border-border-subtle flex items-center justify-center
