    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <textarea
          ...
          maxLength={5000}
          disabled={isDisabled}
          className="w-full px-3 py-2 rounded-md border border-border-subtle
        ...
        {screenshot ? (
          <div className="relative inline-block">
            <img
              ...
              alt="screenshot"
              className="max-h-40 rounded-md border border-border-subtle"
            />
            <button
      ...
      {state === 'success' && (
        <div className="py-2 px-3 rounded-md bg-green-500/10">
      ...
      <button
        ...
        className={`w-full py-2 text-[13px] font-medium rounded-md transition-smooth
